...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .antMatchers("/addManufacturer").hasAuthority("ADMIN")
        .antMatchers("saveManufacturer/").hasAuthority("ADMIN")
        .antMatchers("/editManufacturer/**").hasAuthority("ADMIN")
        .antMatchers("/deleteManufacturer/**").hasAuthority("ADMIN")
