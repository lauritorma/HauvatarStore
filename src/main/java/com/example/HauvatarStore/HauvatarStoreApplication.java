...
public class HauvatarStoreApplication {
	...
	public CommandLineRunner vaateDemo(GarmetRepository gRepository, ManufacturerRepository mrepository) {
		return (args) -> {
			gRepository.save(new Garmet("Koiruliinin villapaituliini", "Koiran vaatteet", 20.0, "K9 Clothing"));
			gRepository.save(new Garmet("Koiruliinin sadetakkinen", "Koiran vaatteet", 25.0, "K9 Clothing"));
			gRepository.save(new Garmet("Kissuliinin sadetakkuli", "Kissan vaatteet", 15.0, "Kitty Clothing"));
			gRepository.save(new Garmet("Kisulin töppöset", "Kissan vaatteet", 5.0, "Kitty Clothing"));
